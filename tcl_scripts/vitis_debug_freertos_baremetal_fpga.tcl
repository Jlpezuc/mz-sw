...
target 1 
fpga -file FreeRTOS/_ide/bitstream/mzsys_wrapper.bit
puts "INFO: Device configured successfully with 'workspace/FreeRTOS/_ide/bitstream/mzsys_wrapper.bit'."
targets -set -nocase -filter {name =~"APU*"}
puts "INFO: Context for 'APU' is selected."
catch {loadhw -hw MicroZohm/export/MicroZohm/hw/mzsys_wrapper.xsa -mem-ranges [list {0x80000000 0xbfffffff} {0x400000000 0x5ffffffff} {0x1000000000 0x7fffffffff}] -regs}
puts "INFO: Hardware design and registers information is loaded from 'workspace/MicroZohm/export/MicroZohm/mzsys_wrapper.xsa'."
