...
#include <math.h>
#include "mz_math_constants.h"
#include "mz_Transformation.h"

mz_3ph_abc_t UVW_system = {0}; 
mz_3ph_dq_t dq_system = {0};
mz_3ph_alphabeta_t alphabeta_system = {0};

mz_6ph_abc_t sixphase_abc = {0};
mz_6ph_alphabeta_t sixphase_alphabeta = {0};
mz_6ph_dq_t sixphase_dq = {0};

mz_9ph_abc_t ninephase_abc = {0};
mz_9ph_alphabeta_t ninephase_alphabeta = {0};
mz_9ph_dq_t ninephase_dq = {0};

mz_3ph_alphabeta_t alphabeta_multiphase_test = {0};
mz_3ph_dq_t dq_multiphase_test = {0};
...
void test_mz_dq_Transformation_output_positive_theta(void){
    UVW_system.a = 1.0f;
    UVW_system.b = -(1.0f / 2.0f);
    UVW_system.c = -(1.0f / 2.0f);
    float theta_el_rad = MZ_PIf / 2.0f;
    mz_3ph_dq_t output = mz_transformation_3ph_abc_to_dq(UVW_system, theta_el_rad);
...
void test_mz_dq_Transformation_output_negative_theta(void){
    UVW_system.a = 1.0f;
    UVW_system.b = -(1.0f / 2.0f);
    UVW_system.c = -(1.0f / 2.0f);
    float theta_el_rad = -1.0f * (MZ_PIf / 2.0f);
    mz_3ph_dq_t output = mz_transformation_3ph_abc_to_dq(UVW_system, theta_el_rad);
    TEST_ASSERT_FLOAT_WITHIN (1e-06, 0.0f, output.d);
    TEST_ASSERT_EQUAL_FLOAT(1.0f, output.q);
    TEST_ASSERT_EQUAL_FLOAT(0.0f, output.zero);
...
void test_mz_inverse_dq_Transformation_output_positive_theta(void){
    dq_system.d = 0.0f;
    dq_system.q = -1.0f;
    float theta_el_rad = MZ_PIf / 2.0f;
    mz_3ph_abc_t output = mz_transformation_3ph_dq_to_abc(dq_system, theta_el_rad);
    TEST_ASSERT_EQUAL_FLOAT(1.0f, output.a);
    TEST_ASSERT_EQUAL_FLOAT(-0.5f, output.b);
    TEST_ASSERT_EQUAL_FLOAT(-0.5f, output.c);
}

void test_mz_inverse_dq_Transformation_output_negative_theta(void){
    dq_system.d = 0.0f;
    dq_system.q = -1.0f;
    float theta_el_rad = -1.0f * (MZ_PIf / 2.0f);
    mz_3ph_abc_t output = mz_transformation_3ph_dq_to_abc(dq_system, theta_el_rad);
...
void test_mz_clarke_Transformation_output(void){
    UVW_system.a = 1.0f;
    UVW_system.b = -(1.0f / 2.0f);
    UVW_system.c = -(1.0f / 2.0f);
    mz_3ph_alphabeta_t output = mz_transformation_3ph_abc_to_alphabeta(UVW_system);
    ...
    output = mz_transformation_3ph_abc_to_alphabeta(UVW_system);
    TEST_ASSERT_FLOAT_WITHIN(1e-07, 0.8660254, output.alpha);
    TEST_ASSERT_EQUAL_FLOAT(0.5f, output.beta);
    TEST_ASSERT_EQUAL_FLOAT(0.0f, output.gamma);
}

void test_mz_inverse_clarke_Transformation_output(void){
    alphabeta_system.alpha = 1.0f;
    alphabeta_system.beta = 0.0f;
    mz_3ph_abc_t output = mz_transformation_3ph_alphabeta_to_abc(alphabeta_system);
    TEST_ASSERT_EQUAL_FLOAT(1.0f, output.a);
    TEST_ASSERT_EQUAL_FLOAT(-0.5f, output.b);
    TEST_ASSERT_EQUAL_FLOAT(-0.5f, output.c);
    alphabeta_system.alpha = 0.8660254f;
    alphabeta_system.beta = 0.5f;
    output = mz_transformation_3ph_alphabeta_to_abc(alphabeta_system);
...
// test vsd output
void test_mz_6ph_clarke_transformation_output(void){
    ...
    mz_6ph_alphabeta_t output = mz_transformation_asym30deg_6ph_abc_to_alphabeta(sixphase_abc);
...
void test_mz_6ph_clarke_inverse_transformation_output(void){
    ...
    mz_6ph_abc_t output = mz_transformation_asym30deg_6ph_alphabeta_to_abc(sixphase_alphabeta);
...
void test_mz_6ph_abc_to_dq_transformation_output(void){
    ...
    mz_6ph_alphabeta_t alphabeta = mz_transformation_asym30deg_6ph_abc_to_alphabeta(sixphase_abc);
    ...
    mz_3ph_dq_t dq_calc = mz_transformation_3ph_alphabeta_to_dq(alphabeta_multiphase_test, theta_el);

    mz_6ph_dq_t output = mz_transformation_asym30deg_6ph_abc_to_dq(sixphase_abc, theta_el);
...
void test_mz_6ph_dq_to_abc_transformation_output(void){
    sixphase_dq.d = -1.0f;
    sixphase_dq.q = -2.0f;
    sixphase_dq.x = -3.0f;
    sixphase_dq.y = -4.0f;
    ...
    mz_3ph_alphabeta_t alphabeta_calc = mz_transformation_3ph_dq_to_alphabeta(dq_multiphase_test, theta_el);
    ...
    mz_6ph_abc_t abc_vgl = mz_transformation_asym30deg_6ph_alphabeta_to_abc(sixphase_alphabeta);

    mz_6ph_abc_t output = mz_transformation_asym30deg_6ph_dq_to_abc(sixphase_dq, theta_el);
...
// test vsd output
void test_mz_9ph_clarke_transformation_output(void){
    ...
    mz_9ph_alphabeta_t output = mz_transformation_9ph_abc_to_alphabeta(ninephase_abc);
...
// test inverse vsd output
void test_mz_9ph_clarke_inverse_transformation_output(void){
    ...
    mz_9ph_abc_t output = mz_transformation_9ph_alphabeta_to_abc(ninephase_alphabeta);
...
void test_mz_ab_to_dq_transformation_output_positive_theta(void){
    alphabeta_multiphase_test.alpha = 2.0f;
    alphabeta_multiphase_test.beta  = 3.0f;
    alphabeta_multiphase_test.gamma = 4.0f;
    float theta_el_rad = MZ_PIf / 8.0f;
    mz_3ph_dq_t output = mz_transformation_3ph_alphabeta_to_dq(alphabeta_multiphase_test, theta_el_rad);
...
void test_mz_ab_to_dq_transformation_output_negative_theta(void){
    alphabeta_multiphase_test.alpha = 2.0f;
    alphabeta_multiphase_test.beta  = 3.0f;
    alphabeta_multiphase_test.gamma = 4.0f;
    float theta_el_rad = -1 * MZ_PIf / 8.0f;
    mz_3ph_dq_t output = mz_transformation_3ph_alphabeta_to_dq(alphabeta_multiphase_test, theta_el_rad);
...
void test_mz_dq_to_ab_inverse_transformation_positive_theta(void){
    dq_multiphase_test.d = 5.0f;
    dq_multiphase_test.q  = 6.0f;
    dq_multiphase_test.zero = 4.0f;
    float theta_el_rad = MZ_PIf / 8.0f;
    mz_3ph_alphabeta_t output = mz_transformation_3ph_dq_to_alphabeta(dq_multiphase_test, theta_el_rad);
...
void test_mz_dq_to_ab_inverse_transformation_negative_theta(void){
    dq_multiphase_test.d = 5.0f;
    dq_multiphase_test.q  = 6.0f;
    dq_multiphase_test.zero = 4.0f;
    float theta_el_rad = -1* MZ_PIf / 8.0f;
...
void test_mz_transformation_9ph_alphabeta_to_dq(void){
    ...
    float theta_el_rad = MZ_PIf / 8.0f;
    mz_9ph_dq_t output = mz_transformation_9ph_alphabeta_to_dq(ninephase_alphabeta, theta_el_rad);
    TEST_ASSERT_FLOAT_WITHIN (1e-06, 2.995809f, output.d);
    TEST_ASSERT_FLOAT_WITHIN (1e-06, 2.006272f, output.q);
...
void test_mz_transformation_9ph_dq_to_alphabeta(void){
    ninephase_dq.d = 5.0f;
    ninephase_dq.q = 6.0f;
    ...
    float theta_el_rad = MZ_PIf / 8.0f;
    mz_9ph_alphabeta_t output = mz_transformation_9ph_dq_to_alphabeta(ninephase_dq, theta_el_rad);
    TEST_ASSERT_FLOAT_WITHIN (1e-06, 2.323297f, output.alpha);
    TEST_ASSERT_FLOAT_WITHIN (1e-06, 7.456694f, output.beta);
...
void test_mz_transformation_9ph_abc_to_dq(void){
    ninephase_abc.a1 = 1.0f;
    ninephase_abc.b1 = 2.0f;
    ninephase_abc.c1 = 3.0f;
    ninephase_abc.a2 = 4.0f;
    ...
    ninephase_abc.c3 = 9.0f;
    float theta_el_rad = MZ_PIf / 8.0f;
    mz_9ph_dq_t output = mz_transformation_9ph_abc_to_dq(ninephase_abc, theta_el_rad);
...
void test_mz_transformation_9ph_dq_to_abc(void){
    ninephase_dq.d = 5.0f;
    ninephase_dq.q = 6.0f;
    ninephase_dq.x1 = 1.1f;
    ninephase_dq.y1 = 1.2f;
    ...
    ninephase_dq.zero = 1.7f;  
    float theta_el_rad = MZ_PIf / 8.0f;  
    mz_9ph_abc_t output = mz_transformation_9ph_dq_to_abc(ninephase_dq, theta_el_rad);
...
void test_vsd_transformation_and_inverse(void){
    ...
    ninephase_abc.b3 = 8.0f;
    ninephase_abc.c3 = 9.0f;
    mz_9ph_alphabeta_t output_alphabeta = mz_transformation_9ph_abc_to_alphabeta(ninephase_abc);
    mz_9ph_abc_t output = mz_transformation_9ph_alphabeta_to_abc(output_alphabeta);
...
void test_9ph_vsd_circular_example(void)
{
    ...
    mz_9ph_dq_t dq_value={
        .q=1.0f
    };

    for (size_t i = 0; i < 189; i++)
    {
         mz_9ph_abc_t abc_value = mz_transformation_9ph_dq_to_abc(dq_value, theta[i]);
         mz_9ph_dq_t dq_reverse = mz_transformation_9ph_abc_to_dq(abc_value,theta[i]);
