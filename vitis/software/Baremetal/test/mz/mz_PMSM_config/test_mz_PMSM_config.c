...
void test_mz_PMSM_config_assert_R_ph(void){
    config.R_ph_Ohm = -0.08f;
    TEST_ASSERT_FAIL_ASSERT(mz_PMSM_config_assert(config));
    config.R_ph_Ohm = 0.0f;
    TEST_ASSERT_FAIL_ASSERT(mz_PMSM_config_assert(config));
}

void test_mz_PMSM_config_assert_Ld(void){
...
void test_mz_PMSM_config_assert_Lq(void){
...
void test_mz_PMSM_config_assert_Psi_PM(void){
    config.Psi_PM_Vs = -0.08f;
    TEST_ASSERT_FAIL_ASSERT(mz_PMSM_config_assert(config));
}

void test_mz_PMSM_config_assert_polePairs(void){
...
void test_mz_PMSM_config_assert_J(void){
...
void test_mz_PMSM_config_assert_I_max(void){
