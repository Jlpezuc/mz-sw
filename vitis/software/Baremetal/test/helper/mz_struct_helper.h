...
void AssertEqual_mz_fixedpoint_definition_t(struct mz_fixedpoint_definition_t expected, struct mz_fixedpoint_definition_t actual, UNITY_UINT line);
...
#define UNITY_TEST_ASSERT_EQUAL_struct_mz_fixedpoint_definition_t(expected, actual, line, message) AssertEqual_mz_fixedpoint_definition_t(expected, actual, line)
