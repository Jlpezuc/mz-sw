#ifndef MZ_ADCLTC2311_H
#define MZ_ADCLTC2311_H
#include <stdint.h>
#include <stdbool.h>
...
#define MZ_ADCLTC2311_CH1  (1U<<0)
#define MZ_ADCLTC2311_CH2  (1U<<1)
#define MZ_ADCLTC2311_CH3  (1U<<2)
#define MZ_ADCLTC2311_CH4  (1U<<3)
#define MZ_ADCLTC2311_CH5  (1U<<4)
#define MZ_ADCLTC2311_CH6  (1U<<5)
#define MZ_ADCLTC2311_CH7  (1U<<6)
#define MZ_ADCLTC2311_CH8  (1U<<7)
#define MZ_ADCLTC2311_CH9  (1U<<8)
#define MZ_ADCLTC2311_CH10 (1U<<9)
#define MZ_ADCLTC2311_CH11 (1U<<10)
#define MZ_ADCLTC2311_CH12 (1U<<11)
#define MZ_ADCLTC2311_CH13 (1U<<12)
#define MZ_ADCLTC2311_CH14 (1U<<13)
#define MZ_ADCLTC2311_CH15 (1U<<14)
#define MZ_ADCLTC2311_CH16 (1U<<15)
#define MZ_ADCLTC2311_CH17 (1U<<16)
#define MZ_ADCLTC2311_CH18 (1U<<17)
#define MZ_ADCLTC2311_CH19 (1U<<18)
#define MZ_ADCLTC2311_CH20 (1U<<19)
#define MZ_ADCLTC2311_CH21 (1U<<20)
#define MZ_ADCLTC2311_CH22 (1U<<21)
#define MZ_ADCLTC2311_CH23 (1U<<22)
#define MZ_ADCLTC2311_CH24 (1U<<23)
#define MZ_ADCLTC2311_CH25 (1U<<24)
#define MZ_ADCLTC2311_CH26 (1U<<25)
#define MZ_ADCLTC2311_CH27 (1U<<26)
#define MZ_ADCLTC2311_CH28 (1U<<27)
#define MZ_ADCLTC2311_CH29 (1U<<28)
#define MZ_ADCLTC2311_CH30 (1U<<29)
#define MZ_ADCLTC2311_CH31 (1U<<30)
#define MZ_ADCLTC2311_CH32 (1U<<31)

// SPI master definitions
#define MZ_ADCLTC2311_MASTER1  (1U<<0)
#define MZ_ADCLTC2311_MASTER2  (1U<<1)
#define MZ_ADCLTC2311_MASTER3  (1U<<2)
#define MZ_ADCLTC2311_MASTER4  (1U<<3)
#define MZ_ADCLTC2311_MASTER5  (1U<<4)
#define MZ_ADCLTC2311_MASTER6  (1U<<5)
#define MZ_ADCLTC2311_MASTER7  (1U<<6)
#define MZ_ADCLTC2311_MASTER8  (1U<<7)
#define MZ_ADCLTC2311_MASTER9  (1U<<8)
#define MZ_ADCLTC2311_MASTER10 (1U<<9)
#define MZ_ADCLTC2311_MASTER11 (1U<<10)
#define MZ_ADCLTC2311_MASTER12 (1U<<11)
#define MZ_ADCLTC2311_MASTER13 (1U<<12)
#define MZ_ADCLTC2311_MASTER14 (1U<<13)
#define MZ_ADCLTC2311_MASTER15 (1U<<14)
#define MZ_ADCLTC2311_MASTER16 (1U<<15)
#define MZ_ADCLTC2311_MASTER17 (1U<<16)
#define MZ_ADCLTC2311_MASTER18 (1U<<17)
#define MZ_ADCLTC2311_MASTER19 (1U<<18)
#define MZ_ADCLTC2311_MASTER20 (1U<<19)
#define MZ_ADCLTC2311_MASTER21 (1U<<20)
#define MZ_ADCLTC2311_MASTER22 (1U<<21)
#define MZ_ADCLTC2311_MASTER23 (1U<<22)
#define MZ_ADCLTC2311_MASTER24 (1U<<23)
#define MZ_ADCLTC2311_MASTER25 (1U<<24)
#define MZ_ADCLTC2311_MASTER26 (1U<<25)
#define MZ_ADCLTC2311_MASTER27 (1U<<26)
#define MZ_ADCLTC2311_MASTER28 (1U<<27)
#define MZ_ADCLTC2311_MASTER29 (1U<<28)
#define MZ_ADCLTC2311_MASTER30 (1U<<29)
#define MZ_ADCLTC2311_MASTER31 (1U<<30)
#define MZ_ADCLTC2311_MASTER32 (1U<<31)

// control register
#define MZ_ADCLTC2311_CR_MODE (1U<<0)
#define MZ_ADCLTC2311_CR_SW_TRIGGER_MODE (1U<<1)
#define MZ_ADCLTC2311_CR_TRIGGER (1U<<2)
#define MZ_ADCLTC2311_CR_SW_RESET (1U<<3)
#define MZ_ADCLTC2311_CR_CONV_VALUE_VALID (1U<<4)
#define MZ_ADCLTC2311_CR_CONFIG_VALUE_0 (1U<<5)
#define MZ_ADCLTC2311_CR_CONFIG_VALUE_1 (1U<<6)
#define MZ_ADCLTC2311_CR_CONFIG_VALUE_2 (1U<<7)

// SPI control register
#define MZ_ADCLTC2311_SPI_CR_SS_N (1U<<0)
#define MZ_ADCLTC2311_SPI_CR_SS_N_STATUS (1U<<1)
#define MZ_ADCLTC2311_SPI_CR_SCLK (1U<<2)
#define MZ_ADCLTC2311_SPI_CR_SCLK_STATUS (1U<<3)
#define MZ_ADCLTC2311_SPI_CR_CONTROL (1U<<4)
#define MZ_ADCLTC2311_SPI_CR_CONTROL_STATUS (1U<<5)
#define MZ_ADCLTC2311_SPI_CR_CPOL (1U<<6)
#define MZ_ADCLTC2311_SPI_CR_CPHA (1U<<7)

// SPI configuration register
#define MZ_ADCLTC2311_SPI_CFGR_CLK_DIV_WIDTH 16U
#define MZ_ADCLTC2311_SPI_CFGR_PRE_DELAY_WIDTH 8U
#define MZ_ADCLTC2311_SPI_CFGR_POST_DELAY_WIDTH 8U
#define MZ_ADCLTC2311_SPI_CFGR_CLK_DIV_LSB 0U
#define MZ_ADCLTC2311_SPI_CFGR_PRE_DELAY_LSB 16U
#define MZ_ADCLTC2311_SPI_CFGR_POST_DELAY_LSB 24U

// status napSleepConfig
#define MZ_ADCLTC2311_NS_MAN_MODE_EN_FAILED (1U<<0)
#define MZ_ADCLTC2311_NS_MAN_MODE_DIS_FAILED (1U<<1)
#define MZ_ADCLTC2311_NS_ALREADY_IN_MODE (1U<<2)
#define MZ_ADCLTC2311_NS_NOT_IN_MODE (1U<<3)
#define MZ_ADCLTC2311_NS_NO_SELECTION (1U<<4)
#define MZ_ADCLTC2311_NAP_PULSES 2
#define MZ_ADCLTC2311_SLEEP_PULSES 4

/**
 * @brief Data type for object adcLtc2311
 *
 */
typedef struct mz_adcLtc2311_t mz_adcLtc2311_t;

/**
 * @brief Enum to determine the trigger mode of a SPI-Master
 * 
 */
enum mz_adcLtc2311_trigger_mode{
 ...
 * 
 */
struct mz_adcLtc2311_channel_config_t{
	float conversion_factor; /**< Factor with which the sum of the offset and the raw value is multiplied */
	struct mz_fixedpoint_definition_t conversion_factor_definition;
 ...
 * 
 */
struct mz_adcLtc2311_spi_master_config_t{
    ...
    enum mz_adcLtc2311_trigger_mode trigger_mode;
};
...
struct mz_adcLtc2311_config_t{
    ...
    struct mz_adcLtc2311_spi_master_config_t spi_master_config;
 ...
 * parameters that are shipped with the given @ref mz_adcLtc2311_config_t configuration struct
 * 
 * The function initializes the hardware by executing the following functions:
 * 
 * <UL>
 * <LI> @ref mz_adcLtc2311_set_triggered_mode </LI>
 * <LI> @ref mz_adcLtc2311_update_conversion_factor </LI>
 * <LI> @ref mz_adcLtc2311_update_offset </LI>
 * <LI> @ref mz_adcLtc2311_update_samples </LI>
 * <LI> @ref mz_adcLtc2311_update_sample_time </LI>
 * <LI> @ref mz_adcLtc2311_update_spi </LI>
 * </UL>
 *
 ...
 *                    If zero, the master_select value from @ref mz_adcLtc2311_config_t is considered instead.
 */
 ...
 * @param self Pointer to driver instance 
 * 
 * @return MZ_FAILURE when the hardware did not acknowledge the update of the value within max_attempts. 
 *         Otherwise, the function returns MZ_SUCCESS.
 */
 ...
 * in @ref mz_adcLtc2311_config_t. master_select determines, which channels are sent to nap mode and
 ...
 * mz_adcLtc2311.h file (public interface of this software module).
 * 
 * @param self Pointer to driver instance
 * 
 * @return MZ_FAILURE if the operation failed. Check the error_code from
 *         @ref mz_adcLtc2311_config_t for details. Otherwise, return value is
 *         MZ_SUCCESS
 */
 ...
 * 
 * The function depends on the master_select and the max_attempts setting
 * in @ref mz_adcLtc2311_config_t. master_select determines, which channels leave nap mode and
 * max_attempts determines the maximum number of attempts to enter the manual
 * control mode of the SPI. Adjust these settings before calling the function.
 * 
 * \#defines for the error_code variable in case of failure are located in the
 ...
 * 
 * The function depends on the master_select and the max_attempts setting
 * in @ref mz_adcLtc2311_config_t. master_select determines, which channels are sent to sleep mode and
 * max_attempts determines the maximum number of attempts to enter the manual
 * control mode of the SPI. Adjust these settings before calling the function.
 * 
 * \#defines for the error_code variable in case of failure are located in the
 ...
 * 
 * The function depends on the master_select and the max_attempts setting
 * in @ref mz_adcLtc2311_config_t. master_select determines, which channels leave sleep mode and
 * max_attempts determines the maximum number of attempts to enter the manual
 * control mode of the SPI. Adjust these settings before calling the function.
 ...
 * 
 * @param self Pointer to driver instance
 * @param master_select Bitmask to select SPI-Masters - use MZ_ADCLTC2311_MASTER defines
 * @param channel_select Bitmask to select ADC-Channels - use MZ_ADCLTC2311_CH32 defines 
