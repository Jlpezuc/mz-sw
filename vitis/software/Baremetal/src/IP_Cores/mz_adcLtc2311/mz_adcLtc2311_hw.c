...
{
	mz_assert_not_zero(base_address);
	return (mz_axi_read_uint32(base_address + ADC_LTC2311_CR));
}

uint32_t mz_adcLtc2311_hw_read_spi_cr(uint32_t base_address)
{
	mz_assert_not_zero(base_address);
	return (mz_axi_read_uint32(base_address + ADC_LTC2311_SPI_CR));
}

uint32_t mz_adcLtc2311_hw_read_spi_cfgr(uint32_t base_address)
{
	mz_assert_not_zero(base_address);
	return (mz_axi_read_uint32(base_address + ADC_LTC2311_SPI_CFGR));
}

uint32_t mz_adcLtc2311_hw_read_master_channel(uint32_t base_address)
{
	mz_assert_not_zero(base_address);
	return (mz_axi_read_uint32(base_address + ADC_LTC2311_MASTER_CHANNEL));
}

uint32_t mz_adcLtc2311_hw_read_channel(uint32_t base_address)
{
	mz_assert_not_zero(base_address);
	return (mz_axi_read_uint32(base_address + ADC_LTC2311_CHANNEL));
}

uint32_t mz_adcLtc2311_hw_read_master_finish(uint32_t base_address)
{
	mz_assert_not_zero(base_address);
	return (mz_axi_read_uint32(base_address + ADC_LTC2311_MASTER_FINISH));
}

uint32_t mz_adcLtc2311_hw_read_master_si_finish(uint32_t base_address)
{
	mz_assert_not_zero(base_address);
	return (mz_axi_read_uint32(base_address + ADC_LTC2311_MASTER_SI_FINISH));
}

uint32_t mz_adcLtc2311_hw_read_master_busy(uint32_t base_address)
{
	mz_assert_not_zero(base_address);
	return (mz_axi_read_uint32(base_address + ADC_LTC2311_MASTER_BUSY));
}

uint32_t mz_adcLtc2311_hw_read_value(uint32_t base_address)
{
	mz_assert_not_zero(base_address);
	return (mz_axi_read_uint32(base_address + ADC_LTC2311_VALUE));
}

uint32_t mz_adcLtc2311_hw_read_adc_available(uint32_t base_address)
{
	mz_assert_not_zero(base_address);
	return (mz_axi_read_uint32(base_address + ADC_LTC2311_ADC_AVAILABLE));
}
...
{
	mz_assert_not_zero_uint32(base_address);
	mz_fixedpoint_axi_write(base_address + ADC_LTC2311_VALUE, value, fixedpoint_definition);
}
