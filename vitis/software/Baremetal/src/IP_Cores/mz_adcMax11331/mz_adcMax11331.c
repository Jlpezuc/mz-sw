...
#if MZ_ADCMAX11331_MAX_INSTANCES > 0U
#include <stdbool.h>
#include <stdint.h>
#include "../../mz/mz_HAL.h"
#include "mz_adcMax11331.h"
#include "mz_adcMax11331_hw.h"

struct mz_adcMax11331_t
{
    bool is_ready;
    struct mz_adcMax11331_config_t config;
};

static size_t instance_counter = 0U;
static mz_adcMax11331_t instances[MZ_ADCMAX11331_MAX_INSTANCES] = {0};

static mz_adcMax11331_t *mz_adcMax11331_allocation(void);

static mz_adcMax11331_t *mz_adcMax11331_allocation(void)
{
    mz_assert(instance_counter < MZ_ADCMAX11331_MAX_INSTANCES);
    mz_adcMax11331_t *self = &instances[instance_counter];
...
void mz_adcMax11331_set_clk_div(mz_adcMax11331_t *self, uint32_t value)
{
    ...
    mz_assert(
        mz_adcMax11331_check_32_bit_int_if_not_more_sign_bits_set_than_spec(
            value,
            MZ_ADCMAX11331_SPI_CFGR_CLK_DIV_WIDTH));
...
void mz_adcMax11331_check_echo_of_master(mz_adcMax11331_t *self)
{
    ...
    mz_adcMax11331_hw_write_master_channel(self->config.base_address, self->config.master_select);
