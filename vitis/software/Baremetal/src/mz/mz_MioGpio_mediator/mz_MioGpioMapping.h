#include "../mz_global_configuration.h"
...
#if HARDWARE_VERSION != 0030010100U //UZ
...
#endif
#if HARDWARE_VERSION == 0030010100U  //MZ
#define EXT_GPIO_1 		14
#define EXT_GPIO_2 		15
#define EXT_GPIO_3 		21
#define EXT_GPIO_4 		22
#define EXT_GPIO_5 		23
#define EXT_GPIO_6      17
#define EXT_GPIO_7      20
#endif

#if HARDWARE_VERSION < 4U
#define EXT_GPIO_6        52 // Rev. 2 and 3
#define EXT_GPIO_7        53 // Rev. 2 and 3
#endif
#if (HARDWARE_VERSION > 3U) && (HARDWARE_VERSION != 0030010100U)
