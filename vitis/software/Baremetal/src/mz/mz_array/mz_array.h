 ...
 * 
 */
typedef struct mz_array_float_t
{
    uint32_t length; /**< length of the vector - use MZ_ARRAY_SIZE makro to determine */
 ...
 * 
 */
typedef struct mz_array_uint32_t
{
    uint32_t length; /**< length of the vector - use MZ_ARRAY_SIZE makro to determine */
 ...
 * 
 */
typedef struct mz_array_int32_t
{
    uint32_t length; /**< length of the vector - use MZ_ARRAY_SIZE makro to determine */
 ...
 * 
 */
typedef struct mz_array_int16_t
{
    uint32_t length; /**< length of the vector - use MZ_ARRAY_SIZE makro to determine */
 ...
 * 
 */
typedef struct mz_array_uint16_t
{
    uint32_t length; /**< length of the vector - use MZ_ARRAY_SIZE makro to determine */
